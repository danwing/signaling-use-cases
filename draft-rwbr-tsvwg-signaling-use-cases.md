...
want. The ISP can choose to limit the prioritization to a specified limit and choose to ignore metadata beyond the bandwidth. This available bandwdith can be signaled through Network-to-Host data specified in {{?I-D.draft-rwbr-sconepro-flow-metadata-latest}}.
